...
def Button():
    #a = 'http://www.vipjiexi.com/tong.php?url=' if varRadio.get() else 'http://www.wmxz.wang/video.php?url='
    a = 'http://www.82190555.com/video.php?url=' if varRadio.get() else 'http://www.sfsft.com/admin.php?url='
